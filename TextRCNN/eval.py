...
tf.app.flags.DEFINE_string('prediction_file', 'zhihu/data/res/rcnn_0.csv', 'predicted csv file.')
...
def main(_):
    ...
    eval_x, eval_x_len = loadEvalSample(FLAGS.eval_data_file, word2id)
    ...
    checkpoint_file = 'zhihu/TextRCNN/runs/1498132016/checkpoints/model-1500' #tf.train.latest_checkpoint(FLAGS.checkpoint_dir)
