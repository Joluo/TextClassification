...
tf.app.flags.DEFINE_string('word_embedding_file', 'zhihu/data/ieee_zhihu_cup/word_embedding_top10k.txt', 'word embedding file')
tf.app.flags.DEFINE_string('training_data', 'zhihu/data/ieee_zhihu_cup/question_train_set_top10k.txt', 'total trianing data of title text')
...
tf.app.flags.DEFINE_integer('sample_len', 300, 'max sample len')
...
tf.app.flags.DEFINE_string('filter_sizes', '2,3,4,5,6', 'filter sizes')
tf.app.flags.DEFINE_integer('num_filters', 512, 'number of filters')
tf.app.flags.DEFINE_float('l2_reg_lambda', 0.0003, 'L2 regular para')
