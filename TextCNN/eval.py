...
tf.app.flags.DEFINE_string('prediction_file', 'zhihu/data/res/cnn_16_6.csv', 'predicted csv file.')
...
def main(_):
    ...
    checkpoint_file = 'zhihu/TextCNN_MultiLabel/runs/1498221524/checkpoints/model-89568'#tf.train.latest_checkpoint(FLAGS.checkpoint_dir)
